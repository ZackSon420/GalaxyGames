...
<head>
  ...
  <title>GALAXY GAMES Ordering System : Order Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a182427_pt2, tbl_staffs_a182427_pt2,
          tbl_customers_a182427_pt2 WHERE
...
<div class="container-fluid">
  <div class="row">
    <br>
    <br>
    <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4" style="border-radius: 15px">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" style="border-radius: 15px;background-color: white;">
      ...
      <form action="order_details.php" method="post" class="form-horizontal" name="frmorder" id="forder">
      <div class="form-group">
          ...
          ?>
          <option value="<?php echo $productrow['fld_product_num']; ?>"><?php echo $productrow['fld_product_console']." ".$productrow['fld_product_name']; ?></option>
          <?php
          }
          $conn = null;
          ?>
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" style="border-radius: 15px;background-color: white;">
      ...
      <tr>
        ...
        <td>
          <a href="order_details.php?delete=<?php echo $detailrow['fld_order_detail_num']; ?>&oid=<?php echo $_GET['oid']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php } ?>
      </table>
