...
<head>
  ...
  <title>GALAXY GAMES Ordering System : Orders</title>
  <!-- Bootstrap -->
  ...
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
    ...
    <tbody>
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a182427_pt2, tbl_staffs_a182427_pt2, tbl_customers_a182427_pt2 WHERE ";
        $sql = $sql."tbl_orders_a182427_pt2.fld_staff_num = tbl_staffs_a182427_pt2.fld_staff_num and ";
        $sql = $sql."tbl_orders_a182427_pt2.fld_customer_num = tbl_customers_a182427_pt2.fld_customer_num ";
      ...
      foreach($result as $orderrow) {
        ...
        <td><?php echo $orderrow['fld_customer_name']; ?></td>
          <td>
            <a href="order_details.php?oid=<?php echo $orderrow['fld_order_num']; ?>" class="btn btn-warning btn-xs" role="button">Details</a>
